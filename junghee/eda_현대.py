...
def run_eda_현대():
    selected = option_menu(
        menu_title=None,
        options=["공장별 판매실적", "📊 지역별 수출 분석", "🚙 차종별 판매 분석"],
    ...
    if selected == "📊 지역별 수출 분석":
        ...
        if selected_countries:
            ...
            1. <span style="color:purple">**시장 동향 파악**</span>: 기아의 글로벌 시장에서의 성과를 시각화하여 전반적인 수출 동향을 파악합니다.
    ...
    """)
        ...
        st.markdown("""---  
         📌 분석 포인트
        - 공장별 판매 실적을 월별로 비교하여 생산/수출 전략 조정에 활용할 수 있습니다.
        - 특정 공장의 계절성이나 생산 변동 추이를 파악할 수 있습니다.
        """)
